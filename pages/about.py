...
st.markdown('# Training\n---\n>Training data is the subset of data that the model is basically trained on the below section shows results of on how the model performed and learned from the training data.\n')
